...
import type { Driver, Roster, RaceWithDetails, Result } from "@f1/shared";
    ...
    <>
      <div className="p-4 bg-white border shadow-lg rounded">
        <div className="flex justify-between items-center mb-3">
          <h1 className="font-[Racing_Sans_One] text-xl text-gray-800">Your Roster</h1>
          {myRoster && !isLocked && (
        ...
        {!myRoster && !isLocked ? (
          ...
          <p className="text-gray-500 font-[Racing_Sans_One] text-lg">
            You never set a roster!
          </p>
        ) : myRoster && isLocked ? (
          <div>
            <p className="text-sm text-gray-500 mb-2">Your roster is locked in.</p>
